...
<head>
    ...
    <link rel="stylesheet" href="<?php echo isset($landing_css) ? $landing_css : base_url('public/css/landing-page.css'); ?>">
</head>
<body>
    <!-- Header -->
    <header>
    ...
    <!-- External JavaScript for Landing Page -->
    <script src="<?php echo isset($landing_js) ? $landing_js : base_url('public/js/landing-page.js'); ?>"></script>
</body>
</html>
